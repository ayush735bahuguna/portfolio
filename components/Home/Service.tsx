...
export default function Services() {
  return (
    <div className="min-h-screen flex justify-center items-center lg:flex-row lg:px-40 max-lg:px-5 border-b-2 border-gray-800 pb-20 bg-black text-white max-lg:flex-col">
